...
Future<CalculConsoResponse> fetchCalculConsoResponse(double cost, double power, int duration, String durationUnitMicro, String durationUnitMacro) async {
  final body = {
    "cost": cost
    ,"power" : power
    ,"duration" : duration
  ...
  if (apiResponse.statusCode == 200) {
    CalculConsoResponse consoResponse =
    CalculConsoResponse.fromJson(jsonDecode(utf8.decode(apiResponse.bodyBytes)));
    return consoResponse;
  } else {
    print(apiResponse.statusCode.toString() + " " + apiResponse.reasonPhrase.toString());
