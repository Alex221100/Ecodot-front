class MyConsumptionModel {
  ...
  MyConsumptionModel.withValues(this.dailyConsumption, this.weeklyConsumption,
      this.monthlyConsumption, this.yearlyConsumption, this.date);
